...
namespace FI.AtividadeEntrevista.BLL
{
    public class BoCliente
    {
        ...
        /// </summary>
        /// <param name="beneficiarios">Objeto de beneficio</param>
        public long IncluirBeneficiario(Beneficiarios beneficiarios)
        {
        ...
        /// <param name="id">id do cliente</param>
        /// <returns></returns>
        public List<Beneficiarios> ConsultarBeneficiarios(long id)
        {
            DAL.DaoBeneficiario ben = new DAL.DaoBeneficiario();
